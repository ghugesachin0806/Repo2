...
const num=0;
  return (
    ...
    <Grid container spacing={2}>
        ...
        <Grid item xs={2}>
                {/* <CssBaseline /> */}
                    ...
                    {/* <Sidebar />    */}
                     ...
                     {/* <Header onPageChange={setpage} style={{marginTop:400}}/> */}
                    </Drawer>
        ...
        {/* page === 'Home'? (
          <Main questions={questions} searchInput={searchInput} />
        ) : */}
        {page === 'Home' ? (
          <Main questions={searchInput === '' ? questions :  filteredQuestions} searchInput={searchInput} Allq={questions}  />
        ) : page === 'FilteredQ' ? (
          <Main questions={searchInput === '' ? questions :  filteredQuestions} tags={tag} searchInput={searchInput} />
        ) : page === 'Community' ? (
          ...
          <Users searchInput={searchInput} questions={questions}/>
        ): page === 'Posts' ? (
          // <Posts searchInput={searchInput} posts={posts} questions={questions}/>
          <PostsMain questions={posts} tags={tag} searchInput={searchInput}/>
        ) :page === 'Settings' ? (
          <Settings searchInput={searchInput} posts={posts} questions={questions}/>
        ) :page === 'Contributions' ? (
           <Posts searchInput={searchInput} posts={posts} questions={questions}/>
          // <Settings searchInput={searchInput} posts={posts} questions={questions}/>
        ):null}
        ...
        {page==='Tags' || page==='Users' || page==='Settings' || page==='Community' || page==='Contributions' ||page==='Home'? (
              null
        ) :page==='Posts'?(

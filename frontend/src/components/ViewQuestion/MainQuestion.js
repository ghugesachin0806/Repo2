  ...
  return (
    <div className="main">
      ...
      <div className="main-container">
        ...
        <button onClick={handlePrevPage}><KeyboardBackspaceIcon/></button>
            ...
            <div className="question-answer">
              ...
              <div className="author">
                ...
                <div className="auth-details">
                  <Avatar {...stringAvatar(questionData?.user?.email)} />
                  <p>
              ...
              <div className="comments">
                  ...
                  {questionData?.comments &&
                    questionData?.comments.map((_qd) => (
                      <p key={_qd?._id}>
                        {_qd.comment}{" "}
                        <span>
                          - {_qd.user ? _qd.user.email.split('@')[0] : "Nate Eldredge"}
                        </span>{" "}
                        {"    "}
                        <small>
                ...
                <Button  variant='contained'  sx={{backgroundColor:'#4287f5'}} onClick={() => setShow(!show)}>Add a comment</Button>
                {show && (
                  <div className="title">
                    <textarea
                      style={{
